...
/**
 * This is the Nested Set  model class for table "categorydemo".
 *
 ...
 */
class Categorydemo extends CActiveRecord
{
        ...
        public function behaviors()
{
    return array(
        'NestedSetBehavior'=>array(
            'class'=>'application.extensions.nestedBehavior.NestedSetBehavior',
            'leftAttribute'=>'lft',
            'rightAttribute'=>'rgt',
  ...
  public static  function printULTree(){
     $categories=Categorydemo::model()->findAll(array('order'=>'root,lft'));
     $level=0;
