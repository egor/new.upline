...
class CategorydemoController extends Controller
{
	...
	public $layout='//layouts/column2';
     ...
     private function registerAssets(){
              ...
              $this->registerJs('webroot.js.admin.jstree','/jquery.jstree.js');
              $this->registerCssAndJs('webroot.js.admin.fancybox',
                                                     '/jquery.fancybox-1.3.4.js',
                                                     '/jquery.fancybox-1.3.4.css');
             $this->registerCssAndJs('webroot.js.admin.jqui1812',
                                                      '/js/jquery-ui-1.8.12.custom.min.js',
                                                      '/css/dark-hive/jquery-ui-1.8.12.custom.css');
            Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/admin/json2/json2.js');
            Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/admin/client_val_form.css','screen');
    }
...
/**	public function accessRules()
	...
	public function actionIndex()
	{
     ...
     //when the tree is loaded.Modify this to suit your needs.Here,we open all nodes on load.
                 $categories= Categorydemo::model()->findAll(array('order'=>'lft'));
                 $identifiers=array();
...
/**
	...
	{
		$model=Categorydemo::model()->findByPk($id);
		if($model===null)
